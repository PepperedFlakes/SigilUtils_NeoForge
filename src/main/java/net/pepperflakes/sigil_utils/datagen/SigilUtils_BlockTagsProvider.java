...
public class SigilUtils_BlockTagsProvider extends BlockTagsProvider {
        public SigilUtils_BlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider,
